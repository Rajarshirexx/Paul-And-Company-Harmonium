          ...
          <div className="lg:w-1/2 flex flex-col">
            ...
            <div className="mt-auto">
              <a 
                ...
                className="btn-accent w-full py-5 text-sm font-bold uppercase tracking-widest flex items-center justify-center gap-3 shadow-2xl shadow-accent/20"
              >
                ...
                <span className="leading-none mt-0.5">Book Now (WhatsApp)</span>
              </a>
            </div>
          </div>
        </div>
