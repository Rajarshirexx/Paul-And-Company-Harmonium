            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div className="md:col-span-2">
                        <h2 className="text-2xl font-display font-bold text-accent mb-4">
                            Paul & Company
                        </h2>
                        <p className="text-secondary/70 max-w-sm leading-relaxed">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-secondary/60">
                            <li>Premium Harmonium Workshop</li>
                            <li>India</li>
                            <li className="pt-2 text-accent">info@paulandcompany.com</li>
                        </ul>
                    </div>
                </div>

                <div className="mt-12 pt-8 border-t border-secondary/10 flex flex-col md:flex-row justify-between items-center text-xs text-secondary/40 space-y-4 md:space-y-0">
